...
seoTitle: 'Licitar comunicación con la administración'
...
faqs:
  ...
  - question: '¿Cuál es el límite económico de un contrato menor para servicios de comunicación?'
    answer: '15.000 € sin IVA (Art. 118 LCSP) para servicios y suministros. Para obras el límite es 40.000 €. Algunos contratos típicos del sector encajan ahí: una memoria anual, una campaña puntual, un vídeo institucional, un plan editorial trimestral. La administración no puede fraccionar deliberadamente un contrato mayor en varios menores para evitar la concurrencia: eso se llama fraccionamiento ilícito y la Cámara de Cuentas lo audita. Cuando el servicio anual de comunicación supera esos 15k €, hay que ir a procedimiento con publicidad sí o sí.'
  - question: '¿Necesito estar inscrito en algún registro para licitar con una administración pública?'
    answer: 'Recomendado pero no siempre obligatorio. El Registro Oficial de Licitadores y Empresas Clasificadas del Sector Público (ROLECE) acredita capacidad de obrar, solvencia económica y técnica de una sola vez, evitando aportar la misma documentación en cada licitación. La inscripción es gratuita y tarda 1-2 meses. Algunas administraciones autonómicas tienen su propio registro (en Andalucía, el RAyAA). Sin inscripción se puede licitar igual, pero hay que aportar todos los documentos en cada concurso, lo cual cuesta tiempo y aumenta el riesgo de errores formales que descartan la oferta sin entrar a evaluarla.'
  - question: '¿Qué solvencia técnica suelen exigir las administraciones para contratos de comunicación?'
    answer: 'Los pliegos de comunicación piden habitualmente: experiencia acreditada en servicios similares (con certificados de buena ejecución de administraciones o entidades equivalentes), volumen de facturación en los tres últimos años por encima del valor estimado del contrato, equipo técnico con currículums y titulaciones, y plan de medios o portfolio adaptado a la administración convocante. Algunos pliegos añaden certificaciones ISO (9001, 14001), código ético o cláusulas sociales. Startidea acompaña la preparación de toda esta documentación cuando una entidad amiga del tercer sector quiere presentarse pero el equipo interno no domina el formato técnico-administrativo.'
  - question: '¿Conviene presentarse a un contrato público por debajo del precio de licitación?'
    answer: 'Solo si el margen real lo permite, no por estrategia comercial. Las bajas temerarias —ofertas más de un porcentaje determinado por debajo de la media— activan un trámite de justificación que muchas veces termina con la oferta excluida o con la administración escarmentada que pide garantías adicionales. Bajar el 5-10% suele ser razonable si la propuesta técnica también es competitiva; bajar el 20-30% es generalmente síntoma de que la empresa no entendió el alcance o que prevé compensar con modificados a posteriori, algo que la fiscalización del contrato bloquea. La administración valora más una oferta económica honesta acompañada de una técnica fuerte.'
  - question: '¿Qué prepara Startidea cuando acompaña una licitación con la administración?'
    answer: 'Cinco entregables: revisión de los pliegos para identificar criterios reales de adjudicación, documentación administrativa completa (DEUC, solvencias, declaraciones responsables), oferta técnica adaptada al sistema de valoración del pliego (no una propuesta genérica), oferta económica con justificación cuando hay riesgo de baja temeraria, y presentación electrónica por la PLACSP o sede correspondiente con el certificado digital de representante. Cuando el procedimiento es abierto y hay varios lotes, se decide a cuáles compensa presentarse y a cuáles no.'
  - question: '¿Startidea acompaña también la ejecución del contrato o solo la presentación?'
    answer: 'Ambas. Una vez adjudicado, hay que firmar el contrato, presentar garantías definitivas si aplican, coordinar el inicio con el responsable del contrato por parte de la administración, ejecutar conforme a calendario, justificar entregas con la documentación contractual exigida y facturar a través de FACe (sistema electrónico de facturación al sector público). Startidea acompaña tanto la presentación como la ejecución, porque la mayoría de problemas con contratos públicos no aparecen en la fase de licitación sino seis meses después, cuando hay que justificar lo entregado o pedir un modificado por razones sobrevenidas.'
---
