...
seoTitle: 'RGPD para fundaciones: 5 documentos clave'
...
faqs:
  ...
  - question: '¿Tiene que tener una fundación Delegado de Protección de Datos (DPO)?'
    answer: 'Solo en algunos supuestos. El RGPD obliga a nombrar DPO cuando la actividad principal implica observación habitual y sistemática a gran escala, o tratamiento a gran escala de categorías especiales de datos (salud, religión, ideología). Una fundación de cooperación al desarrollo que solo gestiona donantes no está obligada. Una fundación que atiende a menores tutelados con expedientes médicos sí puede estarlo. En caso de duda, conviene un análisis específico: nombrar DPO innecesariamente añade coste, no nombrarlo cuando es obligatorio es sancionable.'
  - question: '¿Qué pasa si la AEPD inspecciona una fundación sin estos documentos?'
    answer: 'La AEPD valora dos cosas: si hay tratamientos sin base legal o sin información a los interesados, y si se han adoptado medidas técnicas y organizativas apropiadas. La ausencia del Registro de Actividades de Tratamiento, de las cláusulas informativas o del contrato con encargados es una infracción tipificada. Las sanciones a entidades sin ánimo de lucro existen y han llegado a cifras de cinco dígitos. La buena noticia: si los documentos existen y se aplican —aunque sean mejorables— el enfoque suele ser correctivo antes que sancionador.'
  - question: '¿Sirve copiar la política de privacidad de otra ONG parecida?'
    answer: 'No. Cada entidad trata datos distintos, con bases legales distintas y proveedores distintos. Una política copiada suele tener tratamientos que no se hacen, omitir tratamientos que sí se hacen, mencionar plazos de conservación inexactos y citar bases legales que no corresponden. La AEPD ha sancionado por cláusulas incompletas o engañosas con frecuencia. Adaptar una plantilla oficial al caso real lleva 2-3 horas; copiar la de otro es un atajo que sale caro.'
  - question: '¿Cuánto cuesta a una fundación tener el RGPD en orden?'
    answer: 'Para una fundación pequeña-mediana sin DPO obligatorio, el coste razonable de poner todo en orden la primera vez es de entre €500 y €1.500 si se contrata asesoría externa, dependiendo del número de tratamientos y proveedores. El mantenimiento anual (revisión, actualización de cláusulas, formación al equipo) cabe en una iguala de €30-€80/mes con un asesor especializado. Los servicios all-in-one de cumplimiento con suscripciones de cuatro cifras al año rara vez compensan a una entidad de este tamaño.'
  - question: '¿Y si la fundación trabaja con menores?'
    answer: 'Las medidas se refuerzan. Datos de menores son categoría sensible en la práctica: el consentimiento solo es válido a partir de 14 años en España y por debajo lo prestan los padres o tutores. La fundación necesita un sistema verificable para recabar y archivar ese consentimiento, cláusulas informativas redactadas en lenguaje comprensible para el menor cuando se le dirigen, y análisis de riesgos específico. Es uno de los casos donde el análisis de necesidad de EIPD (Evaluación de Impacto en Protección de Datos) está prácticamente garantizado.'
  - question: '¿Startidea acompaña con el cumplimiento RGPD de una fundación?'
    answer: 'Sí, con dos modalidades. Acompañamiento puntual para construir los documentos desde cero o auditar los existentes (€600-€1.200 según tamaño). Iguala anual para entidades que quieren mantener el cumplimiento al día sin sobresaltos: revisión semestral, actualización de cláusulas, asesoría ante incidentes, formación al equipo. La primera conversación de 30 minutos es sin coste para evaluar el punto de partida y decidir si tiene sentido seguir.'
---
