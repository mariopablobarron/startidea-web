...
tldr: 'Contratar una agencia de comunicación para una ONG exige saber qué puede hacer —y qué no— antes de pedir presupuesto. Un plan de comunicación parte de 2.500 €; la gestión continua de redes, de 800 €/mes; una campaña con causa ronda entre 4.000 € y 8.000 €. El precio exacto se cierra tras un diagnóstico. Y hay casos en los que no merece la pena contratar nada.'
category: 'Comunicación'
audience: 'Tercer sector'
tags: ['comunicación', 'agencia', 'ONG', 'tercer sector', 'presupuesto', 'contratación', 'estrategia']
draft: false
faqs:
  - question: '¿Cuánto cuesta contratar una agencia de comunicación para una ONG?'
    answer: 'Depende del alcance. Un plan de comunicación estratégico parte de 2.500 € como proyecto puntual. La gestión continua de redes sociales —publicaciones, respuestas, métricas mensuales— empieza en torno a 800 €/mes con una agencia especializada en tercer sector. Una campaña con causa (concepto, creatividad, piezas y seguimiento) suele situarse entre 4.000 € y 8.000 € según medios incluidos. El precio definitivo no se puede fijar sin un diagnóstico previo: la dimensión de la entidad, el número de canales y los objetivos concretos lo determinan.'
  - question: '¿Qué diferencia a una agencia especializada en ONG de una generalista?'
    answer: 'Una agencia especializada conoce los códigos del tercer sector: sabe que el donante individual y la institución financiadora no se hablan igual, conoce la regulación de captación de fondos, entiende por qué ciertas imágenes de beneficiarios pueden ser éticamente problemáticas y tiene experiencia en campañas de causa sin presupuestos publicitarios holgados. Una agencia generalista puede tener más músculo creativo, pero tardará meses en entender el contexto, y ese tiempo lo paga la entidad. No es que una sea mejor que la otra; es que sirven para cosas distintas.'
  - question: '¿Puede una ONG pequeña permitirse una agencia de comunicación?'
    answer: 'Depende de qué se entiende por agencia. Una ONG con un presupuesto anual inferior a 150.000 € raramente puede sostener una retención mensual de servicios sin que ese gasto distorsione su estructura de costes. Lo que sí puede hacer es contratar proyectos concretos y acotados: un plan de comunicación, un rediseño de identidad o el lanzamiento de una campaña puntual. Otra opción es la consultoría por horas para revisar materiales o acompañar a la persona de comunicación interna. La clave es no confundir "necesito ayuda con la comunicación" con "necesito una agencia a tiempo completo".'
  - question: '¿Qué pasa si la agencia no tiene experiencia en tercer sector?'
    answer: 'No es automáticamente descartable, pero implica un coste de aprendizaje. Una agencia sin experiencia en sector no lucrativo puede no entender que el destinatario de una campaña no es quien la financia, sino quien se beneficia de ella; puede proponer lenguajes o imágenes que choquen con los valores de la entidad, o desconocer las restricciones éticas en comunicación con colectivos vulnerables. Si se contrata una agencia generalista, conviene asegurarse de que haya alguien interno que pueda hacer de interlocutor crítico y filtro de contenidos.'
---
...
Antes de pedir propuestas, merece la pena tener resuelto el propio [plan de comunicación](/notas/plan-comunicacion-ong): una agencia trabaja mejor cuando la entidad llega con claridad sobre sus objetivos, sus audiencias y sus mensajes principales.
...
Las [señales para elegir una agencia de tercer sector](/notas/como-elegir-agencia-tercer-sector) incluyen también la dimensión de la propia organización: no todo encaja con cualquier tamaño.
