...
faqs:
  ...
  - question: '¿La IA puede sustituir al equipo humano en una organización?'
    answer: 'Puede automatizar tareas concretas y debe automatizarlas cuando no añaden valor humano: una memoria económica, una factura, una transcripción, un primer borrador de presentación. Pero la decisión, el criterio, la presencia y la relación siguen siendo humanas y se vuelven más valiosas a medida que la IA se generaliza. Un estudio meta-analítico de 2024 sobre combinaciones humano-IA mostró que, en tareas de decisión, el equipo mixto rinde con frecuencia peor que el mejor de los dos por separado: juntar humano y IA no basta, hay que diseñar bien la relación. Por eso emerge el rol del facilitador.'
  - question: '¿Cómo se entrena a alguien para usar bien la IA?'
    answer: 'Tres habilidades por encima de los prompts: presencia (notar qué pasa antes de preguntar), discernimiento (saber cuándo la respuesta del modelo es elegante pero vacía), y conexión (mantener la relación humano-humano que la IA podría sustituir si nadie la cuida). La técnica viene después. Una persona que sabe facilitar conversaciones sin IA aprende a facilitar con IA en pocas semanas. Una persona que solo conoce prompts pero no sabe leer un grupo, ni sostener silencios, ni desbloquear miedo, no consigue resultados con ninguna herramienta. La IA amplifica al facilitador; no lo sustituye.'
  - question: '¿Conviene crear una IA propia entrenada con los datos de mi organización?'
    answer: 'Solo en algunos casos. Cuando una entidad entrena una IA solo con sus propios datos, esa IA termina pensando exactamente como la entidad. Si lo que se busca es eficiencia interna sobre tareas repetidas, perfecto. Si lo que se busca es desafiar el statu quo y aportar perspectiva nueva, no. Una fundación grande que ha hecho IA propia descubrió que su IA solo sabía decir lo que la fundación ya pensaba: un espejo, no una contraparte. La pregunta correcta antes de invertir en IA propia es para qué se quiere distinta de la IA general. Si la respuesta es "para que coincida más conmigo", no compensa.'
  - question: '¿Qué errores se ven con más frecuencia en organizaciones que adoptan IA?'
    answer: 'Cuatro patrones. Primero: confundir velocidad con productividad — sacar muchas más cosas que antes, pero cosas que no enganchan. Segundo: delegar la decisión a la IA porque su respuesta llega rápido y suena segura, sin volver a preguntar. Tercero: usar IA para llenar huecos que antes ocupaba el contacto humano, debilitando las relaciones que sostienen a la organización. Cuarto: presentar como propio un texto o un vídeo claramente generado por IA, perdiendo credibilidad ante audiencias que ya saben distinguirlo. Los cuatro tienen la misma raíz: no haber decidido para qué se está usando la IA antes de empezar a usarla.'
  - question: '¿La IA puede ayudar a tomar mejores decisiones en una organización?'
    answer: 'Sí, si se usa para abrir el espacio de análisis y no para cerrarlo. Pedir al modelo varias perspectivas sobre el mismo problema, confrontar su primera respuesta, pedir argumentos en contra de la opción que parecía clara, son usos fértiles que efectivamente mejoran la calidad de la decisión final. Aceptar literalmente la primera respuesta del modelo y ejecutarla suele degradar la decisión: el modelo es complaciente por diseño y devolverá una versión amable de lo que ya pensabas. El criterio es la diferencia. Y el criterio sigue siendo humano.'
  - question: '¿Startidea acompaña a organizaciones en su relación con la IA?'
    answer: 'Sí, con dos modalidades. Acompañamiento puntual de 4-6 semanas para diseñar el primer uso de IA con sentido: para qué, dónde no, quién decide, qué se mide. Iguala mensual para organizaciones que ya usan IA pero quieren revisar críticamente cómo la usan y formar a su equipo en el uso fértil, no en el atajo. La primera conversación de 30 minutos es sin coste para evaluar si tiene sentido seguir. No se vende "transformación digital" como buzzword: se ayuda a tener una relación con la IA que la organización pueda explicar y defender.'
---
...
1. Antes de preguntar a la IA, escribir la pregunta en una frase. Si no cabe en una frase, todavía no se sabe lo que se quiere.
2. Pedir al modelo que la confronte, no que la confirme. "Dame argumentos en contra de esta hipótesis". "¿Qué se está pasando por alto?".
3. No aceptar la primera respuesta. Las tres o cuatro siguientes vueltas son donde aparece lo interesante.
4. Cerrar la sesión sin haber decidido. La decisión se toma después, fuera del chat, en conversación con personas o con uno mismo.
