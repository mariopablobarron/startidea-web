...
draft: false
faqs:
  - question: '¿Qué diferencia un plan de comunicación de una ONG del de una empresa?'
    answer: 'El contexto de recursos, audiencias y métricas. Una empresa mide retorno económico; una ONG mide impacto social, captación de socios y credibilidad institucional. Las audiencias de una ONG son múltiples y a veces contradictorias: beneficiarios, donantes, patronato, voluntariado, medios, instituciones públicas. El plan tiene que hablarle a todos con coherencia de fondo pero mensajes diferenciados. Y los recursos son siempre más ajustados, lo que obliga a priorizar con más rigor.'
  - question: '¿Cuánto dura un plan de comunicación para una ONG?'
    answer: 'El horizonte habitual es doce meses, con revisión trimestral. Más corto no da tiempo a ver resultados; más largo en un entorno cambiante (convocatorias, crisis, cambios políticos) se queda obsoleto. El plan se construye en un documento de 15-25 páginas, pero lo que importa es el calendario operativo mensual que lo acompaña: sin él, el plan queda en intención.'
  - question: '¿Quién debe participar en la elaboración del plan de comunicación?'
    answer: 'Mínimo cuatro perfiles: la dirección (para alinear con la estrategia de la organización), el responsable de comunicación o la persona que lo ejecutará (para que sea realista), alguien del equipo de captación o fundraising (para coordinar mensajes y campañas) y una persona del patronato o consejo (para validar el tono institucional). Si la organización tiene beneficiarios con voz, incorporar su perspectiva enriquece el plan.'
  - question: '¿Cuáles son los errores más frecuentes en un plan de comunicación de ONG?'
    answer: 'Cinco son recurrentes: no definir audiencias con precisión (hablar a "todo el mundo" es no hablar a nadie), no establecer métricas antes de empezar (si no sabes qué mides, no sabes si funciona), sobredimensionar los canales (estar en seis redes con un equipo de dos personas es hacerlo todo mal), no reservar presupuesto para distribución (el mejor contenido sin distribución no llega a nadie) y no incluir mecanismo de revisión (un plan que no se revisa en doce meses no es un plan, es un archivo).'
  - question: '¿Puede Startidea elaborar el plan de comunicación de mi organización?'
    answer: 'Sí. El proceso empieza con un diagnóstico de la situación actual (auditoría de mensajes, canales y resultados de los últimos doce meses), sigue con la definición de audiencias y narrativa, y cierra con el plan editorial, el calendario y los indicadores de seguimiento. La primera llamada de 30 minutos es sin coste para valorar encaje y alcance.'
---
