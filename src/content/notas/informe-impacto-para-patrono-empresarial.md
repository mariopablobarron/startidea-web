...
seoTitle: 'Informe de impacto que sí lee una empresa'
...
tags: ['impacto social', 'memoria', 'empresas', 'patrocinio', 'RSC', 'sostenibilidad', 'fundraising', 'rendición de cuentas']
draft: false
tldr: 'Un patrono empresarial no lee la memoria de cuarenta páginas: necesita una página con una cifra clara que pueda pegar en su propio informe de sostenibilidad y defender ante su comité. El buen informe de impacto para empresa da el dato antes que el relato, traduce la actividad a una métrica que a la empresa le sirve, y hace fácil citarlo. No es menos rigor: es rigor puesto donde el lector lo va a usar.'
faqs:
  - question: '¿Qué mira una empresa en el informe de impacto de una entidad social?'
    answer: 'Mira, sobre todo, qué puede contar ella con eso. Un responsable de sostenibilidad o de RSC necesita una cifra defendible —personas atendidas, toneladas evitadas, empleos generados por su aportación— que pueda incluir en su propio informe anual y justificar ante su dirección. No busca el relato completo del proyecto: busca el dato que convierte su donación en algo que enseñar. El informe que se lo da fácil es el que consigue la renovación.'
  - question: '¿Por qué no sirve la memoria anual larga para captar empresas?'
    answer: 'Porque está pensada para justificar, no para que la usen. La memoria administrativa de cuarenta páginas cumple una función legal y de transparencia, pero pide un tiempo que el responsable de una empresa no tiene y no destila el único dato que a él le importa. No es que esté mal hecha: es que responde a otra pregunta. Para la empresa hace falta una pieza corta, con la cifra delante y fácil de citar.'
  - question: '¿Cómo se mide el impacto para que le sirva a un patrocinador?'
    answer: 'Traduciendo la actividad a una unidad que la empresa entienda y pueda usar: no "hemos trabajado mucho", sino "tu aportación financió la inserción de 12 personas" o "cada euro generó X de retorno social". La clave es elegir una métrica honesta, medible y ligada a lo que la empresa aportó, y sostenerla en el tiempo para poder comparar año contra año. Una cifra clara y bien construida vale más que diez indicadores vagos.'
  - question: '¿Un informe corto para empresa sacrifica rigor?'
    answer: 'No, si está bien hecho. Ser breve no es ser laxo: la cifra que se pone delante tiene que estar sostenida por un método serio, y conviene que el informe corto enlace o acompañe al detalle completo para quien quiera comprobarlo. El rigor no está en la longitud, está en que el dato sea verdad y se pueda auditar. La pieza corta es la puerta; la memoria completa sigue existiendo detrás.'
---
...
**1. Una métrica traducida al lenguaje del lector.** No "hemos realizado numerosas actividades", sino "vuestra aportación financió la inserción laboral de 12 personas". La actividad se traduce a una unidad que la empresa entienda, pueda defender y quiera enseñar. Elegir bien esa unidad es la mitad del trabajo — y va de la mano de [medir el impacto social con un método serio](/notas/como-medir-impacto-social-organizacion).
