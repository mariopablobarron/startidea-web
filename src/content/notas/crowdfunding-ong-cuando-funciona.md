...
tags: ['crowdfunding', 'fundraising', 'captación de fondos', 'donaciones', 'tercer sector', 'base social', 'micromecenazgo']
draft: false
tldr: 'El crowdfunding funciona para proyectos concretos, con historia clara y base social previa que active el primer impulso. No sirve para cubrir gastos estructurales ni para captar donantes desde cero. Es un complemento puntual, no la columna vertebral de ninguna estrategia de financiación.'
faqs:
  - question: '¿Cuánto dinero puede recaudar una ONG pequeña con crowdfunding?'
    answer: 'Depende del tamaño de la base social y de la concreción del proyecto. Una asociación con 300-500 contactos activos puede recaudar entre 3.000 € y 15.000 € en una campaña bien diseñada. Sin base previa, el rango realista es 500-2.000 €, principalmente del círculo cercano. Las cifras millonarias que aparecen en prensa corresponden a organizaciones con miles de seguidores activos o a proyectos virales, que son la excepción, no la norma.'
  - question: '¿Qué plataforma de crowdfunding conviene a una ONG española?'
    answer: 'Las más usadas en España son Verkami, Goteo y Teaming. Goteo tiene sesgo hacia proyectos con impacto social. Teaming funciona de forma distinta: grupos de personas que aportan 1 € al mes de forma recurrente. Para proyectos culturales o de recompensas, Verkami. La elección depende de si se busca donación puntual, recurrencia o desgravación fiscal.'
  - question: '¿El crowdfunding de donación tiene desgravación fiscal para los donantes?'
    answer: 'Solo si la entidad tiene reconocido el régimen fiscal de la Ley 49/2002 (fundaciones y asociaciones declaradas de utilidad pública). En ese caso, las aportaciones pueden desgravarse igual que cualquier donativo. La plataforma no otorga por sí sola ningún beneficio fiscal: la desgravación la genera el estatus de la entidad, no el canal de recaudación.'
  - question: '¿Se puede usar crowdfunding para financiar gastos corrientes o personal?'
    answer: 'Se puede intentar, pero rara vez funciona. Los donantes responden a proyectos concretos con principio y fin: "construimos un huerto comunitario", "publicamos el informe", "llevamos a diez jóvenes al campamento". Los gastos de estructura —nóminas, alquiler, suministros— generan muy poco impulso y son difíciles de comunicar con urgencia. Si la necesidad real es financiar estructura, la vía más eficaz es la cuota de socios recurrente o las subvenciones de funcionamiento.'
---
...
**Para cubrir gasto estructural.** Nóminas, alquiler, seguros, gastos de administración. No hay historia que lo haga atractivo. Los donantes quieren financiar impacto, no estructura. Aunque el gasto estructural sea imprescindible para que el impacto ocurra, comunicarlo así no funciona en crowdfunding. Para financiar estructura, la vía más eficaz es la cuota de socios recurrente; la nota sobre [captación de socios con cuota mensual](/notas/base-social-cuota-mensual-ong) explica el modelo con detalle.
