...
draft: false
faqs:
  - question: '¿Qué es el fundraising y en qué se diferencia de pedir subvenciones?'
    answer: 'Fundraising es la gestión activa y sistemática de todas las fuentes de financiación de una organización: socios individuales, donantes puntuales, grandes donantes, alianzas con empresas, herencias y legados, subvenciones públicas y fondos europeos. Las subvenciones son una fuente dentro del fundraising, no su sinónimo. Una asociación que solo busca subvenciones no hace fundraising: hace tramitación, con todos los riesgos de dependencia que eso implica.'
  - question: '¿Cuántas fuentes de financiación debería tener una asociación?'
    answer: 'La regla de referencia es que ninguna fuente supere el 40% del presupuesto total. Con una sola fuente, la organización sobrevive o muere según lo que decida un tercero. Con tres o cuatro fuentes diversificadas, la pérdida de una se puede absorber. En la práctica, una asociación pequeña puede empezar con dos fuentes principales y un plan de tres años para diversificar a cuatro o cinco.'
  - question: '¿Qué es mejor para una asociación: conseguir más socios o pedir más subvenciones?'
    answer: 'Depende del perfil. Los socios generan financiación recurrente, predecible y sin justificación administrativa: son el activo más valioso a largo plazo. Las subvenciones son más cuantiosas por proyecto pero inciertas, temporales y costosas de justificar. La estrategia ideal combina ambas: socios como base estable y subvenciones para proyectos singulares que no se pueden financiar con cuotas.'
