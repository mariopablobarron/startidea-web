...
faqs:
  - question: '¿Por qué se dice que una subvención pagada tarde es un préstamo al Estado?'
    answer: 'Porque durante el tiempo que la administración tarda en pagar, la actividad ya se ha ejecutado con dinero de la entidad: has pagado nóminas, proveedores y gastos con tus recursos o con una línea de crédito, a la espera de un reembolso que llega meses después. En la práctica has financiado tú una política pública y el Estado te la devuelve sin intereses cuando puede. Es un préstamo a coste cero para quien paga tarde y a coste real para quien espera.'
  - question: '¿Cómo se calcula el coste real de una subvención que se cobra con retraso?'
    answer: 'Una aproximación sencilla: importe adelantado × meses de retraso × coste mensual de tu capital. Si adelantas 50.000 euros durante 18 meses y tu póliza de crédito cuesta un 6% anual, el coste financiero ronda los 4.500 euros, sin contar las horas de gestión ni el coste de oportunidad de tener ese dinero inmovilizado. Ese número es lo que hay que restar a la subvención para saber cuánto vale de verdad.'
  - question: '¿Merece la pena pedir subvenciones que se pagan muy tarde?'
    answer: 'Depende del importe, del retraso y de la liquidez de la entidad. Algunas siguen mereciendo la pena aunque paguen tarde, porque el importe compensa el coste de esperar. Otras, especialmente las pequeñas con justificación pesada y pago lento, cuestan más en gestión y financiación de lo que aportan. La clave es dejar de decir sí por defecto y decidir con el coste real delante: no todas las subvenciones son buenas por ser dinero público.'
  - question: '¿Qué puede hacer una entidad para reducir el coste de cobrar tarde?'
    answer: 'Tres cosas prácticas: negociar anticipos o pagos a cuenta cuando la convocatoria lo permita, mantener una reserva de tesorería propia para no depender de la póliza más cara, y calcular el coste financiero de cada subvención antes de presentarse para priorizar las que pagan antes o adelantan fondos. No elimina el problema —lo marca el calendario de la administración—, pero convierte una sorpresa de tesorería en una decisión tomada con los ojos abiertos.'
---
...
- **Sostener una reserva propia** para no depender de la póliza más cara justo cuando más se necesita. Es la lógica de la [tesorería defensiva](/notas/tesoreria-defensiva-ong-esperar-pago-administracion): esperar el pago de la administración sin que la espera te ahogue.
