...
tldr: 'La innovación social es encontrar formas nuevas y mejores de resolver un problema social, cuyo valor se queda en la sociedad y no en un dueño privado. No es tecnología por sí misma, ni RSC, ni marketing con causa: puede ser una idea organizativa muy simple. Ejemplos: el microcrédito, las cooperativas de energía, el comercio justo, la Wikipedia o el modelo Housing First. Lo que la define no es la novedad, sino que resuelve mejor y para más gente.'
category: 'Estrategia'
audience: 'Todas'
tags: ['innovación social', 'tercer sector', 'impacto social', 'estrategia', 'definición', 'ejemplos', 'empresas con propósito']
draft: false
faqs:
  - question: '¿Qué es la innovación social, explicado de forma sencilla?'
    answer: 'La innovación social es una forma nueva de resolver un problema social —pobreza, soledad, exclusión, despoblación, acceso a la energía— que funciona mejor que las soluciones que existían y cuyo beneficio se queda principalmente en la sociedad, no en un propietario privado. La clave está en las tres partes: resuelve un problema social real, lo hace de una manera nueva (aunque sea una idea organizativa muy simple, no necesariamente tecnología) y el valor generado es colectivo. No hace falta inventar nada espectacular: a veces innovar es organizar de otro modo algo que ya existía.'
  - question: '¿Puedes dar ejemplos concretos de innovación social?'
    answer: 'El microcrédito (prestar pequeñas cantidades sin avales a personas excluidas del banco), las cooperativas de energía renovable donde los vecinos son dueños de lo que consumen, el comercio justo, los bancos de tiempo (intercambiar horas de ayuda en lugar de dinero), la Wikipedia como conocimiento construido y abierto por todos, o el modelo Housing First, que da vivienda estable a personas sin hogar antes de exigirles nada a cambio. Ninguno necesitó una gran tecnología: necesitaron una idea distinta sobre cómo organizar la solución.'
  - question: '¿En qué se diferencia la innovación social de la responsabilidad social corporativa (RSC)?'
    answer: 'La RSC es lo que una empresa hace para reducir su impacto negativo o devolver algo a la sociedad, normalmente al margen de su negocio principal: una donación, un voluntariado corporativo, una política ambiental. La innovación social es más profunda: cambia la forma de resolver el problema, y a menudo el propósito social está en el centro de la actividad, no en un anexo. Una empresa puede tener buena RSC sin innovar socialmente, y una innovación social puede nacer fuera de cualquier empresa —en una asociación, una administración o un grupo de vecinos.'
  - question: '¿La innovación social es solo cosa de ONG y del tercer sector?'
    answer: 'No. Nace muchas veces en el tercer sector porque está más cerca de los problemas, pero la practican también empresas con propósito, cooperativas, universidades y administraciones públicas. Un ayuntamiento que rediseña un trámite para que llegue a quien más lo necesita, una empresa cuyo modelo de negocio resuelve un problema social, o una cooperativa de cuidados están haciendo innovación social. Lo que importa no es quién la hace, sino que resuelva mejor un problema colectivo.'
---
...
1. **Resuelve un problema social real** — pobreza, soledad, exclusión, desempleo, despoblación, acceso a la vivienda o a la energía. No un problema inventado para vender algo.
2. **Lo hace de una manera nueva** — distinta a como se venía haciendo. Y aquí está el malentendido más común: *nueva no quiere decir tecnológica*. Muchas veces la innovación es una idea organizativa muy simple.
3. **El valor generado es colectivo** — el beneficio principal va a las personas y a la comunidad, no a la cuenta de resultados de un propietario.
...
- **El [Copiloto de Subvenciones](/copiloto-subvenciones)** usa inteligencia artificial para que una entidad pequeña, sin equipo técnico, pueda encontrar, preparar y justificar convocatorias públicas. Democratiza el acceso a una financiación que antes solo dominaban quienes podían pagar asesoría.
- El acompañamiento en **[consultoría e innovación social](/consultoria)** ayuda a organizaciones a ordenar su estrategia, medir su impacto y diseñar proyectos que resuelvan de verdad, no solo que suenen bien.
