...
tags: ['tesorería', 'financiación', 'subvenciones', 'desfase de pago', 'administración pública', 'tercer sector', 'gestión económica', 'ONG', 'asociaciones']
draft: false
faqs:
  - question: '¿Cuánto tarda en pagar la Junta de Andalucía en convenios de tercer sector?'
    answer: 'En convenios de financiación con entidades de acción social, el plazo habitual entre la justificación y el abono efectivo oscila entre 12 y 20 meses. El Observatorio del Tercer Sector de Andalucía registra medias superiores a 14 meses en los últimos tres ejercicios. La variación depende de la línea, la delegación y si hay reparos de Intervención pendientes.'
  - question: '¿Qué es una línea ICO y pueden acceder las asociaciones?'
    answer: 'Las líneas ICO (Instituto de Crédito Oficial) son préstamos bancarios con tipos de interés subvencionados por el Estado para distintos colectivos. Las entidades sin ánimo de lucro pueden acceder a través de las entidades financieras colaboradoras con la Línea ICO Empresas y Emprendedores, presentando sus estatutos, cuentas anuales y la resolución de la subvención como garantía. El tipo máximo suele estar 2-3 puntos por debajo del mercado.'
  - question: '¿Qué es el factoring de facturas contra la administración?'
    answer: 'El factoring es la venta de un crédito pendiente de cobro a una entidad financiera, que adelanta el importe menos una comisión (normalmente 1-3%). En el caso del sector público español, las facturas de proveedores registradas en el FACe (Punto General de Entrada de Facturas) son cedibles a entidades de factoring especializadas. No todas las entidades de tercer sector son "proveedoras" en sentido estricto, pero las que tienen convenios con cláusula de pago reconocido pueden negociar condiciones similares.'
  - question: '¿Cómo funciona el anticipo en un convenio de subvención?'
    answer: 'La Ley General de Subvenciones permite que las convocatorias establezcan anticipos de hasta el 100% de la subvención si se aportan garantías suficientes. En la práctica, la Junta de Andalucía suele establecer anticipos del 50-80% en las órdenes de bases, con garantía bancaria o aval de una entidad aseguradora. Solicitar el anticipo en el plazo establecido es un derecho, no una petición especial: muchas entidades lo desconocen y esperan el pago final.'
  - question: '¿Cuánto fondo de maniobra necesita una entidad con financiación pública mayoritaria?'
    answer: 'La regla práctica es tener disponible en cuenta un mínimo equivalente a 6 meses de gastos fijos (personal, sede, seguros) sin contar subvenciones. Con dependencia pública del 70%+, ese colchón sube a 9 meses. Para entidades pequeñas (<200k€ de presupuesto), conseguir ese nivel de reserva puede llevar años y requiere asignar un porcentaje de los ingresos de captación privada a fondo patrimonial, no a gasto corriente.'
---
