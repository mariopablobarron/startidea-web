...
seoTitle: 'Cómo leer una convocatoria de subvención'
...
faqs:
  ...
  - question: '¿Qué son los criterios de valoración y por qué son lo más importante?'
    answer: 'Son la tabla con la que el órgano gestor puntúa cada solicitud y reparte el dinero en concurrencia competitiva. Son lo más importante porque determinan qué se valora y con cuántos puntos: un proyecto excelente que no responde a los criterios puntúa bajo, y uno modesto alineado con la baremación puntúa alto. Se leen antes de redactar, no después, porque la memoria debe escribirse en el orden y el lenguaje de esos criterios.'
  - question: '¿Cuándo NO conviene presentarse a una subvención?'
    answer: 'Cuando la entidad no cumple un requisito excluyente, cuando el proyecto no encaja con el objeto real de la convocatoria, cuando la puntuación máxima alcanzable según los criterios es baja, o cuando el coste de preparar y justificar supera el beneficio neto esperado. Decir que no a tiempo libera recursos para las convocatorias en las que sí se puede ganar.'
  - question: '¿Qué diferencia hay entre las bases reguladoras y la convocatoria?'
    answer: 'Las bases reguladoras fijan las reglas generales y estables de la línea de ayuda: quién puede ser beneficiario, qué gastos son elegibles, cómo se justifica. La convocatoria es la apertura concreta de un plazo: importe disponible, fechas y, a veces, criterios específicos de ese año. Hay que leer las dos, porque la convocatoria remite constantemente a las bases y muchos requisitos clave solo aparecen ahí.'
  - question: '¿Puede Startidea analizar si una convocatoria encaja con mi entidad?'
    answer: 'Sí. El diagnóstico de encaje analiza objeto, requisitos, criterios de valoración y plazos frente al perfil de la organización, y devuelve si tiene sentido presentarse, qué puntuación máxima es alcanzable y qué documentación hace falta. Si el encaje no existe, se dice antes de invertir tiempo en la memoria. La primera conversación de 30 minutos es sin coste.'
---
...
Startidea hace ese diagnóstico y, cuando el encaje existe, prepara el expediente completo y lo presenta con certificado digital. El enfoque está en [la página de tramitación de subvenciones](/subvenciones/presentar), y la primera conversación de 30 minutos es sin coste.
