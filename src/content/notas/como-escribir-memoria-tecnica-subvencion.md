...
pubDate: 2026-06-21
tldr: 'La memoria técnica es lo que más puntúa en una subvención, pero suele redactarse para describir el proyecto, no para responder a los criterios de valoración. Cada apartado —diagnóstico, objetivos, actividades, indicadores— debe mapearse al baremo. Esta guía da la estructura, cómo escribir para puntuar y los errores que descartan memorias técnicamente buenas.'
updatedDate: 2026-06-21
category: 'Financiación'
audience: 'Tercer sector'
tags: ['subvenciones', 'memoria técnica', 'redacción de proyectos', 'criterios de valoración', 'financiación', 'tercer sector', 'formulación de proyectos']
draft: false
faqs:
  - question: '¿Qué es la memoria técnica de una subvención?'
    answer: 'Es el documento donde se describe el proyecto para el que se pide la ayuda: la necesidad que atiende, los objetivos, las actividades, los resultados esperados y la capacidad de la entidad para ejecutarlo. Es la parte que más puntúa en la mayoría de convocatorias, porque sobre ella se aplican los criterios de valoración. El presupuesto y la documentación administrativa la acompañan, pero la memoria es lo que decide casi todo.'
  - question: '¿Qué apartados lleva una memoria técnica?'
    answer: 'Aunque cada convocatoria tiene su modelo, casi todas piden lo mismo: diagnóstico o justificación de la necesidad, objetivos (general y específicos), descripción de actividades, metodología, cronograma, población destinataria, resultados esperados con indicadores, sistema de evaluación y experiencia de la entidad. Lo importante no es rellenar los apartados, sino que cada uno responda a un criterio de valoración del baremo.'
  - question: '¿Por qué se rechazan memorias técnicas de proyectos buenos?'
    answer: 'Casi siempre por lo mismo: la memoria describe el proyecto pero no responde a los criterios con los que el evaluador puntúa. Objetivos sin indicadores medibles, actividades sin relación clara con los objetivos, un diagnóstico genérico que no cita datos del territorio, ausencia de sistema de evaluación, o un presupuesto que no cuadra con las actividades. Son fallos de redacción, no de proyecto: el proyecto puede ser excelente y la memoria no puntuar.'
  - question: '¿Cuánto debe ocupar una memoria técnica?'
    answer: 'Lo que pidan las bases, ni más ni menos. Algunas convocatorias limitan la extensión por apartado o el total de páginas; superarlo puede excluir. Cuando no hay límite, la regla es responder a cada criterio con la profundidad que ese criterio puntúa y no rellenar de paja. Una memoria de 12 páginas bien mapeada al baremo puntúa más que una de 30 que repite ideas y no aporta datos.'
---
...
Por eso el primer paso no es redactar, es [leer la convocatoria y su baremo antes de escribir nada](/notas/leer-convocatoria-subvencion-antes-de-redactar). Quien escribe sin tener delante los criterios de valoración escribe a ciegas.
