...
seoTitle: 'Métricas de email marketing en una ESFL'
...
metaDescription: 'Email marketing en una ESFL: las cuatro métricas que de verdad indican si funciona la comunicación por correo, y las que solo distraen sin aportar nada.'
pubDate: 2026-05-26
...
tags: ['email marketing', 'métricas', 'newsletter', 'comunicación', 'ESFL', 'ONG', 'tercer sector', 'medición']
draft: false
faqs:
  - question: '¿Cuál es una buena tasa de apertura para una newsletter de ONG?'
    answer: 'Depende del tamaño de la lista y del tipo de suscriptores. Para listas segmentadas de donantes activos, por encima del 35% es bueno. Para listas mixtas grandes (>5.000), el 20-25% ya es aceptable. Las listas muy pequeñas (<500 suscriptores) suelen tener tasas de apertura artificialmente altas (40-60%) porque incluyen principalmente contactos con relación directa con la entidad.'
  - question: '¿Es grave tener muchas bajas después de un envío?'
    answer: 'Depende de qué signifiquen esas bajas. Si se producen tras un email de captación de fondos, pueden ser personas que no están preparadas para dar pero que siguen interesadas en el contenido. Si se producen tras un email de contenido, es señal de que el contenido no responde a las expectativas de esa parte de la lista. Una tasa de bajas >0,5% por envío es una señal para revisar la segmentación o el tipo de contenido, no para dejar de enviar.'
  - question: '¿Cómo sé si mi email está generando donaciones o renovaciones de cuota?'
    answer: 'La forma directa es incluir un enlace de donación o de renovación con un parámetro UTM específico del email (ej. ?utm_source=newsletter&utm_campaign=enero2026). Google Analytics o el panel de tu plataforma de pagos te permite rastrear cuántas personas llegaron desde ese enlace y completaron la transacción. Sin tracking de conversión, las métricas de email solo miden atención, no acción.'
  - question: '¿Con qué frecuencia debo revisar las métricas?'
    answer: 'Revisa métricas de envío (apertura, clics) en las 48h posteriores a cada email. Las métricas de conversión (donaciones, renovaciones, voluntarios captados) revísalas mensualmente con el contexto de los envíos de ese mes. Las métricas de lista (crecimiento, bajas, rebotes) revísalas trimestralmente. Revisar cada semana sin actuar sobre lo que ves es tiempo perdido.'
---
...
Si queréis mejorar el email de vuestra entidad de forma sistemática — desde la segmentación hasta la medición — el [taller de email marketing para el tercer sector](/laboratorio/cursos/email-marketing-segmentado-tercer-sector) de Startidea cubre exactamente esto en formato práctico de cuatro horas.
