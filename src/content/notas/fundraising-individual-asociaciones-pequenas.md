...
pubDate: 2026-05-26
tldr: 'Una asociación de menos de diez personas puede captar donaciones individuales sin copiar el modelo de las grandes ONG: empieza por la red propia, con un alta sencilla y agradecimiento real, y un proceso mínimo viable. Lo que funciona no es acumular herramientas, sino constancia y cercanía con quien ya conoce la causa.'
updatedDate: 2026-05-26
category: 'Financiación'
audience: 'Tercer sector'
tags: ['fundraising', 'donaciones', 'socios', 'captación', 'asociaciones pequeñas', 'tercer sector', 'financiación']
draft: false
faqs:
  - question: '¿Cuántos donantes necesita una asociación pequeña para que el fundraising individual valga la pena?'
    answer: 'No hay un umbral mínimo universal, pero con menos de 50 donantes activos el retorno de la inversión en herramientas de CRM sofisticadas no se justifica. Con 50-200 donantes, una hoja de cálculo bien mantenida y un email mensual personalizado superan en resultados a cualquier plataforma cara mal usada. A partir de 200 donantes empieza a tener sentido invertir en herramientas específicas.'
  - question: '¿Qué herramienta de pago recurrente recomendáis para asociaciones pequeñas?'
    answer: 'Depende del contexto. Si la mayoría de vuestros donantes son particulares españoles, Stripe con un formulario sencillo es la opción más limpia (0,9% + 0,25€ por transacción en Europa). Si buscáis un botón de donar sin configuración técnica, PayPal o Bizum (para España) son más accesibles para donantes mayores. Para cuotas de socio, la domiciliación bancaria (SEPA) sigue siendo la más barata a largo plazo.'
  - question: '¿Es necesario cumplir algún requisito fiscal para emitir recibos de donativo deducibles?'
    answer: 'Para que un donativo sea deducible en el IRPF español, la entidad debe estar acogida a la Ley 49/2002 (entidades sin ánimo de lucro de utilidad pública o acogidas al régimen fiscal especial). No todas las asociaciones cumplen este requisito automáticamente. Si vuestra asociación no está acogida, podéis igualmente recibir donaciones, pero no podéis emitir certificados de deducción fiscal. Consulta con gestoría antes de comunicar deducibilidad.'
  - question: '¿Cómo se pide una donación sin que parezca una petición de limosna?'
    answer: 'El error más común es pedir dinero explicando los problemas de la entidad en lugar de el impacto para el donante o para los beneficiarios. Una petición efectiva responde a tres preguntas: qué pasa si no se hace nada, qué hace exactamente la donación, y cómo sabe el donante que funcionó. El modelo que funciona: historia concreta de un caso + problema + solución + resultado medible + petición específica ("con 30€ al mes cubrimos X durante un año").'
---
...
Si queréis revisar la mezcla de ingresos de vuestra entidad y ver dónde tiene más sentido poner el foco, el [diagnóstico de fundraising](/diagnostico) de Startidea analiza exactamente eso: de dónde viene el dinero ahora, qué riesgos tiene esa estructura y qué palancas tienen más potencial.
