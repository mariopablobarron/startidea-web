...
seoTitle: 'Errores en la justificación de una subvención'
...
tags: ['subvenciones', 'justificación', 'reintegro', 'gastos elegibles', 'tercer sector', 'tramitación']
draft: false
tldr: 'Una justificación de subvención se cae, sobre todo, por gastos no elegibles o fuera del periodo de ejecución, por falta de trazabilidad entre el gasto y lo aprobado, por documentación que no cuadra con la memoria y por no acreditar la difusión exigida. La consecuencia es el reintegro: devolver el dinero con intereses. Se evita preparando la justificación desde el día uno, no al final.'
faqs:
  - question: '¿Qué es la justificación de una subvención?'
    answer: 'Es el proceso por el que la entidad beneficiaria acredita ante la Administración que ha ejecutado el proyecto subvencionado y gastado el dinero conforme a lo aprobado. Incluye una memoria de actuación (qué se hizo) y una memoria económica (en qué se gastó), con las facturas y justificantes de pago. Sin justificación correcta y en plazo, la ayuda concedida puede tener que devolverse.'
  - question: '¿Qué es un reintegro y cuándo se produce?'
    answer: 'El reintegro es la obligación de devolver, total o parcialmente, el dinero recibido, normalmente con los intereses de demora. Se produce cuando la justificación es insuficiente o incorrecta: gastos no elegibles, fuera de plazo, no acreditados, incumplimiento de la finalidad o de obligaciones como la difusión. No siempre implica mala fe; muchas veces es un error de gestión evitable.'
  - question: '¿Qué gastos son elegibles en una subvención?'
    answer: 'Solo los que las bases reguladoras definen como subvencionables, realizados dentro del periodo de ejecución, efectivamente pagados dentro del plazo de justificación y directamente vinculados a la actividad aprobada. Los gastos previos a la concesión, los no previstos en el presupuesto aprobado o los que carecen de factura y prueba de pago suelen rechazarse.'
  - question: '¿Se puede cambiar el proyecto una vez concedida la subvención?'
    answer: 'Solo dentro de lo que permiten las bases y, en muchos casos, comunicándolo y solicitando autorización antes de ejecutar el cambio. Modificar partidas, importes o actuaciones por cuenta propia y reflejarlo solo en la justificación es una de las causas más habituales de reparo. Ante cualquier desviación, lo prudente es consultar al órgano gestor antes, no después.'
  - question: '¿Puede Startidea encargarse de la justificación de una subvención?'
    answer: 'Sí. Startidea acompaña todo el ciclo: además de preparar y presentar el expediente, organiza la justificación —imputación de gastos, recopilación de facturas y justificantes de pago, memorias de actuación y económica, y acreditación de la difusión— para presentarla completa y en plazo. La primera conversación de 30 minutos es sin coste.'
---
