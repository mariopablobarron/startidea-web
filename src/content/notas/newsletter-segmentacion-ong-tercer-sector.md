...
draft: false
faqs:
  - question: '¿Cuántos segmentos necesita una ONG pequeña en su newsletter?'
    answer: 'Tres es suficiente para empezar: socios/donantes (quieren saber qué se hace con su dinero), beneficiarios o usuarios de servicios (quieren información útil y oportunidades), y público general o simpatizantes (quieren inspiración e impacto). Una organización con menos de 2.000 contactos no necesita más. La trampa es crear 8 segmentos y no tener capacidad editorial para mantenerlos.'
  - question: '¿Qué herramienta de email marketing es mejor para una entidad sin ánimo de lucro?'
    answer: 'Mailchimp tiene plan gratuito hasta 500 contactos con segmentación básica. Brevo (antes Sendinblue) ofrece plan gratuito hasta 300 emails/día con automatizaciones. MailerLite tiene plan gratuito hasta 1.000 contactos con automatizaciones y landing pages. Para organizaciones con más de 5.000 contactos y necesidad de CRM, ActiveCampaign o Hubspot (con descuento para ESFL) tienen más potencia. Lo importante es que la herramienta dure: cambiar de plataforma cada dos años destruye el historial de aperturas y clics.'
  - question: '¿Cada cuánto debe enviarse la newsletter de una ONG?'
    answer: 'Mensual para la newsletter principal de impacto, quincenal si hay contenido editorial propio suficiente, semanal solo si hay un equipo de comunicación dedicado. Las envíos urgentes (emergencias, campañas de captación, eventos) se añaden sobre esta base. El error más común es la irregularidad: publicar tres veces en enero y desaparecer hasta abril. La cadencia consistente, aunque baja, siempre gana.'
  - question: '¿Cómo se recopilan datos de los contactos para poder segmentar?'
    answer: 'Con formularios de alta inteligentes: en lugar de pedir solo email, añadir una pregunta de tipo "¿Cómo te relacionas con nosotros?" con opciones predefinidas. Con la importación histórica: revisar cómo llegó cada contacto a la lista (alta web, evento, donación, convenio) y usar esa información como segmento de origen. Con etiquetas en las herramientas: registrar quién abre qué tipo de contenido y usar esos datos para refinar los segmentos.'
  - question: '¿Vale la pena segmentar si la lista tiene solo 300 contactos?'
    answer: 'Sí, pero con una segmentación mínima (donantes vs. no donantes es suficiente para empezar). Con 300 contactos el trabajo manual es asumible y el impacto es inmediato: un email específico para los 80 donantes activos puede generar 3 veces más respuesta que uno genérico enviado a los 300.'
---
