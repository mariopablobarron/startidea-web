...
faqs:
  - question: '¿Cómo se calcula la tasa de bajas (churn) de socios de una ONG?'
    answer: 'Se divide el número de socios que se dieron de baja durante el año entre el número de socios que había al comienzo del año, y se multiplica por cien. Si una entidad empezó el año con 400 socios y perdió 60, su tasa de bajas es del 15%. Conviene medirla sobre el saldo inicial, no sobre el final, y separar las bajas voluntarias de los impagos técnicos, porque se combaten de forma distinta.'
  - question: '¿Qué tasa de bajas de socios es normal en el tercer sector?'
    answer: 'Como referencia práctica, por debajo del 10% anual la base es saludable; entre el 10% y el 20% hay margen claro de mejora; por encima del 20% existe un problema de fidelización que ninguna campaña de captación llega a compensar, porque se capta por la puerta de delante lo que se pierde por la de atrás. Lo importante no es la cifra exacta, sino medirla cada año y ver si sube o baja.'
  - question: '¿Por qué se dan de baja los socios de una organización?'
    answer: 'La minoría se va por un enfado o por un cambio de prioridades, y contra eso poco se puede hacer. La mayoría se pierde por dos vías silenciosas: el impago técnico —una tarjeta caducada o una cuenta cambiada que devuelve el recibo— y la desvinculación —meses sin recibir una sola noticia de la organización hasta que la cuota deja de tener sentido. Esas dos causas son evitables y son donde está casi todo el margen.'
  - question: '¿Cómo se recupera un socio que ha dejado de pagar?'
    answer: 'Un recibo devuelto no es una baja: es un socio que casi siempre sigue queriendo estar. Se recupera con un aviso rápido, humano y sin reproche —"no ha sido posible cobrar tu cuota, ¿actualizamos los datos?"— por el canal que la persona use de verdad, y con una segunda oportunidad de pago fácil. Actuar en la primera semana recupera a una parte importante; dejarlo pasar meses convierte un problema técnico en una baja definitiva.'
---
...
Quien quiera construir la base desde cero encontrará ese enfoque en [cómo construir una cuota mensual estable](/notas/base-social-cuota-mensual-ong); esta nota asume que la base ya existe y se centra en no perderla.
...
2. **Contacto de impacto regular.** El socio quiere saber qué ha pasado con su dinero. Un mensaje trimestral honesto —una historia real, un dato concreto, un gracias— vale más que una memoria de sesenta páginas al año. Es la vacuna contra la desvinculación.
3. **No tratar a quien ya está dentro como a un desconocido.** El peor mensaje que puede recibir un socio de cinco años es una campaña de captación dirigida a él como si no existiera. Segmentar para no pedir a quien ya da.
4. **Una llamada al año a los de más recorrido.** A la base histórica, la que sostiene la casa, una voz humana una vez al año la fideliza más que diez correos.
