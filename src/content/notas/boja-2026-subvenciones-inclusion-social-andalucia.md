...
seoTitle: 'BOJA 2026: subvenciones inclusión social'
...
metaDescription: 'BOJA 2026: 15 líneas de subvención de la Junta de Andalucía para el tercer sector, con beneficiarios, importes y documentación por línea.'
pubDate: 2026-05-27
...
faqs:
  ...
  - question: '¿Cuánto tiempo lleva preparar el expediente?'
    answer: 'Con toda la documentación administrativa disponible, la preparación de la memoria técnica y el presupuesto justificado lleva entre 3 y 10 días hábiles dependiendo de la complejidad del proyecto. Lo que suele retrasar el proceso es la obtención de certificados (AEAT y TGSS tardan 1-2 días si se solicitan por sede electrónica) y la redacción de la memoria si se parte de cero. Startidea recomienda iniciar el proceso antes del 10 de junio para tener margen ante imprevistos.'
  - question: '¿Qué es el Copiloto de Subvenciones de Startidea y cómo ayuda con estas líneas?'
...
## Las 15 líneas y quién puede pedir cada una
...
1. **Estatutos actualizados** con sello del registro de asociaciones o fundaciones.
2. **CIF en vigor** de la entidad.
3. **Acreditación del representante legal**: acta de nombramiento, DNI y apoderamiento si corresponde.
4. **Certificado AEAT** al corriente de obligaciones tributarias (válido 6 meses).
5. **Certificado TGSS** al corriente de pagos a la Seguridad Social (válido 6 meses).
6. **Memoria de actividades del último ejercicio** cerrado.
...
La [ficha completa de las 15 líneas con los botones de solicitud directa](/subvenciones/boja-2026-inclusion-social) está disponible en el portal de Startidea. Para comprobar en menos de un minuto si vuestra entidad puede optar a alguna de estas líneas, el [widget de elegibilidad express](/subvenciones/boja-2026-inclusion-social#elegibilidad) solo necesita el CIF.
