...
seoTitle: 'Cómo crear base social con cuota mensual'
...
faqs:
  ...
  - question: '¿Cuánto debería aportar la base social al presupuesto de una entidad?'
    answer: 'No hay una cifra única, pero la referencia sana es que ninguna fuente supere el 40% del presupuesto. Si una entidad cubre hoy el 80% con dinero público, el objetivo realista de tres años es llevar la cuota de socios al 20-30% del total. No se trata de renunciar a las subvenciones, sino de que dejen de ser el único pilar que sostiene la estructura.'
  - question: '¿Puede una asociación pequeña captar socios sin departamento de captación?'
    answer: 'Sí. La primera oleada de socios casi nunca viene de la publicidad, sino de la red que ya existe: equipo, voluntariado, junta directiva, familias beneficiarias y aliados. Con una propuesta de valor clara, un formulario de alta con domiciliación SEPA y una rutina de agradecimiento, una entidad pequeña puede llegar a sus primeros cien socios sin contratar a nadie. El departamento llega después, cuando los números justifican la inversión.'
  - question: '¿Qué métricas hay que vigilar en una base social de socios?'
    answer: 'Tres por encima del resto: la tasa de bajas o churn (cuántos socios se dan de baja al año), el coste de captación de un socio (cuánto cuesta conseguir uno nuevo) y el valor del socio a lo largo de su vida (cuánto aporta de media antes de irse). Con esas tres cifras se sabe si la base crece de verdad o solo tapa las bajas, y cuánto se puede invertir en captar sin perder dinero.'
  - question: '¿Puede Startidea ayudar a construir la base social de mi organización?'
    answer: 'Sí. El proceso empieza con un diagnóstico de la mezcla de ingresos actual y su grado de dependencia, sigue con el diseño de la propuesta de valor del socio y el circuito de alta, y cierra con el plan de captación y fidelización con hitos y responsables. La primera conversación de 30 minutos es sin coste.'
---
