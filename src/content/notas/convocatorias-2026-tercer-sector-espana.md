...
seoTitle: 'Convocatorias 2026 para el tercer sector'
...
tags: ['convocatorias', 'subvenciones', '2026', 'tercer sector', 'financiación', 'BDNS', 'planificación']
draft: false
tldr: 'Conocer las convocatorias con tiempo suficiente para presentarse bien es, en la práctica, una ventaja competitiva. Esta guía explica el mapa de fuentes públicas de financiación en España, por qué casi siempre se llega tarde y cómo construir un sistema de vigilancia que avise antes de que abra el plazo.'
faqs:
  - question: '¿Qué es la BDNS y para qué sirve?'
    answer: 'La Base de Datos Nacional de Subvenciones (BDNS) es el registro oficial donde todas las administraciones públicas españolas están obligadas a publicar sus convocatorias de subvenciones. Se puede consultar de forma gratuita en infosubvenciones.es. Es el punto de partida imprescindible porque recoge convocatorias de todos los niveles administrativos: estatal, autonómico y local.'
  - question: '¿Con cuánta antelación suelen publicarse las convocatorias?'
    answer: 'Depende del nivel administrativo y del tipo de convocatoria. Algunas estatales se anuncian con meses de antelación. Las autonómicas y locales pueden publicarse con apenas tres o cuatro semanas de plazo. En la práctica, hay convocatorias que abren y cierran en menos de un mes, lo que hace inútil enterarse por casualidad.'
  - question: '¿Cómo sé si una convocatoria encaja con mi entidad antes de invertir tiempo?'
    answer: 'Hay cuatro preguntas rápidas: ¿puede presentarse este tipo de entidad? ¿El ámbito territorial es el correcto? ¿El objeto de la convocatoria coincide con la actividad de la organización? ¿El importe mínimo o máximo tiene sentido para el proyecto disponible? Si alguna respuesta es no, la convocatoria no encaja, aunque el nombre parezca relevante.'
  - question: '¿Sirve de algo suscribirse al boletín oficial para estar al día de convocatorias?'
    answer: 'El BOE y los boletines autonómicos son fuentes primarias y fiables, pero no están pensados para vigilancia sistemática: el volumen de publicaciones es enorme y mezcla convocatorias con cualquier otro tipo de resolución. Para vigilancia eficaz es preferible usar alertas específicas en la BDNS o en agregadores como la sección de subvenciones de infosubvenciones.es, que filtran por tipo de destinatario y sector.'
---
