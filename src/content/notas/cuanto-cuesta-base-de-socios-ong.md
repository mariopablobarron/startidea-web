...
tags: ['fundraising', 'base social', 'captación', 'socios', 'ONG', 'tercer sector', 'tesorería']
draft: false
tldr: 'El coste de captar un socio (CAC) es lo que gastas en conseguirlo dividido entre los socios que consigues; su valor (LTV) es la cuota mensual por los meses que se queda. Un socio no es rentable el primer día: tarda meses en cubrir lo que costó captarlo. Crecer sin conocer estos dos números puede vaciar la caja aunque el número de socios suba. La palanca más barata casi nunca es captar más, sino perder menos.'
faqs:
  - question: '¿Qué es el coste de captación de un socio (CAC)?'
    answer: 'Es todo lo que una entidad gasta en conseguir socios nuevos —campañas, anuncios, la persona que capta, la agencia de calle— dividido entre el número de socios que efectivamente entran y se quedan. Si una campaña cuesta 6.000 € y trae 120 socios que permanecen, el CAC es 50 € por socio. Casi ninguna organización pequeña lo calcula, y por eso no sabe si está creciendo o subvencionando su propio crecimiento.'
  - question: '¿Cuánto tarda un socio en ser rentable?'
    answer: 'Depende de la cuota y del coste de captación. Un socio captado por 50 € que paga 10 €/mes tarda cinco meses en devolver lo que costó — y solo a partir de ahí aporta. Si ese socio se da de baja al cuarto mes, la entidad perdió dinero con él. Por eso el número que de verdad importa no es cuántos socios entran, sino cuántos siguen a los doce meses.'
  - question: '¿Qué es más rentable: captar más socios o retener a los que hay?'
    answer: 'Casi siempre retener. Captar un socio nuevo cuesta varias veces más que conservar uno existente, y el socio que ya dijo que sí una vez tiene mucha más probabilidad de seguir si se le cuida. La mayoría de las organizaciones invierten casi todo en captación y casi nada en fidelización, cuando la palanca más barata está en no perder a quien ya está.'
  - question: '¿Cómo empieza una entidad pequeña a medir esto sin CRM caro?'
    answer: 'Con una hoja de cálculo basta para empezar: cuánto se gastó en captar el último año, cuántos socios entraron, cuántos se dieron de baja y cuál es la cuota media. Con esos cuatro datos ya sale el coste de captación, la tasa de baja y una estimación del valor de cada socio. La herramienta cara viene después; el hábito de mirar el número viene primero.'
---
