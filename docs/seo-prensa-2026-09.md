...
- Integración y verificación pública de la nueva versión: pendientes.
...
Los despliegues actuales recrean el contenedor y en la tanda anterior se observaron 404 transitorios durante el arranque, recuperados al quedar saludable. Se verificará la nueva versión publicada; no se altera infraestructura ni se garantiza disponibilidad continua durante la recreación.
